...
class LazyString implements \Stringable, \JsonSerializable
{
     ...
     */
    public static function fromCallable(callable|array $callback, mixed ...$arguments)
    {
    ...
    public static function fromStringable(string|int|float|bool|\Stringable $value)
    {
        if (\is_object($value)) {
