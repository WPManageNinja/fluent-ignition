...
final class Headers
{
     ...
     * @return $this
     */
    public function addMailboxHeader(string $name, Address|string $address)
    {
     ...
     * @return $this
     */
    public function addIdHeader(string $name, string|array $ids)
    {
     ...
     * @return $this
     */
    public function addPathHeader(string $name, Address|string $path)
    {
     ...
     * @return $this
     */
    public function addHeader(string $name, mixed $argument, array $more = [])
    {
